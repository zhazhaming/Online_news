package com.example.api.controller.article;
...
public interface ArticlePortalControllerApi {
    ...
    public CommonResponse list(@RequestParam String keyword,
    ...
    public CommonResponse queryArticleListOfWriter(@RequestParam String writerId,
                                                    @ApiParam(name = "page", value = "查询下一页的第几页", required = false)
                                                    @RequestParam Integer page,
                                                    @ApiParam(name = "pageSize", value = "分页的每一页显示的条数", required = false)
                                                    @RequestParam Integer pageSize);
    ...
    public CommonResponse queryGoodArticleListOfWriter(@RequestParam String writerId);

    @GetMapping("detail")
    @ApiOperation(value = "文章详情查询", notes = "文章详情查询", httpMethod = "GET")
    public CommonResponse detail(@RequestParam String articleId);
    ...
    public CommonResponse readArticle(@RequestParam String articleId, HttpServletRequest request);
}
