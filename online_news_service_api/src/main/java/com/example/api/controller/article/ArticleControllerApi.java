...
public interface ArticleControllerApi {
    ...
    public CommonResponse createArticle(@RequestBody @Valid NewArticleBO newArticleBO,
                                                BindingResult result);

    @PostMapping("queryMyList")
    @ApiOperation(value = "查询用户的所有文章列表", notes = "查询用户的所有文章列表", httpMethod = "POST")
    public CommonResponse queryMyList(@RequestParam  String userId,
    ...
    public CommonResponse queryAllList(@RequestParam Integer status,
    ...
    public CommonResponse doReview(@RequestParam String articleId,
    ...
    public CommonResponse withdraw(@RequestParam String userId,
                                    @RequestParam String articleId);
}
