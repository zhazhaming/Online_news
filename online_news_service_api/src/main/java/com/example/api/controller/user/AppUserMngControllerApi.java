...
public interface AppUserMngControllerApi {
    ...
    public CommonResponse queryAll(@RequestParam String nickname,
    ...
    public CommonResponse userDetail(@RequestParam String userId);

    @PostMapping("freezeUserOrNot")
    @ApiOperation(value = "冻结用户或者解冻用户", notes = "冻结用户或者解冻用户", httpMethod = "POST")
    public CommonResponse freezeUserOrNot(@RequestParam String userId,
